...
export default function SelectionList({ sortedSelected, API_URL, language }) {
  return (
    <div className="flex-1 flex flex-col gap-2 min-h-0 min-w-0">
      ...
      <div className="grid grid-cols-3 auto-rows-max gap-2.5 overflow-y-auto flex-1 p-2 bg-element border border-muted/10 rounded-lg content-start min-h-0 min-w-0 isolate">
