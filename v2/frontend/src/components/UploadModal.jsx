  ...
  return (
    ...
    >
      ...
      <div className="w-80 bg-modal-surface border-r border-foreground/5 flex flex-col items-center p-6 shrink-0 relative">
        ...
        {/* Connected Account Badge directly below the video player */}
        <ConnectedAccountBadge language={language} className="mt-3.5" />

        <span className="text-[11px] text-foreground/45 mt-2 truncate max-w-full font-mono">{activeVideo.name}</span>
      </div>
